                ...
                select: function() {
                    ...
                    f.each(function(e, l) {
                        ...
                        var v = "string" == typeof r.attr("lay-search"),
                            ...
                            m = t(['<div class="' + (v ? "" : "layui-unselect ") + a + (c ? " layui-select-disabled" : "") + '">', '<div class="' + n + '"><input placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "" : "readonly") + ' onfocus="' + ($_GET['index'] != 'shoplist' ? 'this.blur()' : '') + '" class="layui-input' + (v ? "" : " layui-unselect") + (c ? " " + u : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group" : "") + '">' + function(e) {
                                var t = [];
...
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
    ...
    var t = layui.$,
        ...
        z = ['<table cellspacing="0" cellpadding="0" border="0" class="layui-table" ', '{{# if(d.data.skin){ }}lay-skin="{{d.data.skin}}"{{# } }} {{# if(d.data.size){ }}lay-size="{{d.data.size}}"{{# } }} {{# if(d.data.even){ }}lay-even{{# } }}>', "<tbody id=\"tbody\"></tbody>", "</table>"].join(""),
