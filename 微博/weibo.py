import re,rsa,json,requests,time,base64,binascii
import urllib.parse
...
class WeiBoLogin(object):
    ...
    def get_json_data(self, su_value):
        ...
        try:
            ...
            json_data = {}
            print("WeiBoLogin get_json_data error: %s", excep)

        print("WeiBoLogin get_json_data: %s", json_data)
        return json_data
